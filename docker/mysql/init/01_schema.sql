...
-- Este archivo solo contiene la estructura (DDL).
-- Para cargar datos de prueba: npm run db:seed
-- Para limpiar datos de prueba: npm run db:clean
-- Para resetear todo:           npm run db:reset
-- ============================================================
...
CREATE TABLE IF NOT EXISTS customers (
  ...
  INDEX idx_customers_tenant_whatsapp (tenant_id, whatsapp),
...
CREATE TABLE IF NOT EXISTS orders (
  ...
  INDEX idx_orders_tenant_status  (tenant_id, status_key),
  INDEX idx_orders_tenant_created (tenant_id, created_at),
  INDEX idx_orders_tenant_type    (tenant_id, type),
...
CREATE TABLE IF NOT EXISTS reservations (
  ...
  INDEX idx_reservations_tenant_date   (tenant_id, date),
